...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model1->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/cube.txt", "../Engine/data/marble.tga");
	if(!result)
	{
	...
	result = m_Model2->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/cube.txt", "../Engine/data/metal.tga");
	if(!result)
	{
	...
	result = m_Model3->Initialize(m_D3D->GetDevice(), m_D3D->GetDeviceContext(), "../Engine/data/cube.txt", "../Engine/data/stone.tga",
								  "../Engine/data/normal.tga");
	if(!result)
	{
